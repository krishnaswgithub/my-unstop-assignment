...
export default function SideBar({ showSideBar, setShowSideBar }) {
  ...
  return (
    <div className={`sidePanel ${showSideBar ? "sidepanel-mobile" : ""}`}>
      ...
      <div
        className={`sidePanelItem ${path === "dashboard" ? "selected" : ""}`}
        onClick={() => {
      ...
      <div
        className={`sidePanelItem ${path === "" ? "selected" : ""}`}
        onClick={() => {
          navigationHandler("assessment");
        }}
      >
        <div>
      ...
      <div
        className={`sidePanelItem ${path === "library" ? "selected" : ""}`}
        onClick={() => {
      ...
      <div
        className={`sidePanelItem ${path === "roundStatus" ? "selected" : ""}`}
        onClick={() => {
          navigationHandler("roundStatus");
        }}
      >
